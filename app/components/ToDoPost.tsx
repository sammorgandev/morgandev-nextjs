...
export default function ToDoPost() {
	...
	return (
		<form action="#" className="relative">
			<div className="overflow-hidden bg-white rounded-lg border border-gray-300 shadow-sm focus-within:border-indigo-500 focus-within:ring-1 focus-within:ring-indigo-500">
